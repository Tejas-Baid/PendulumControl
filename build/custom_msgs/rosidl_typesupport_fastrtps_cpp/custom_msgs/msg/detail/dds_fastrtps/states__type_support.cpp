...
#include "custom_msgs/msg/detail/states__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::States & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: theta
  cdr << ros_message.theta;
  // Member: theta_dot
  cdr << ros_message.theta_dot;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::States & ros_message)
{
  // Member: theta
  cdr >> ros_message.theta;
  ...
  size_t current_alignment)
{
  ...
  // Member: theta_dot
  {
    size_t item_size = sizeof(ros_message.theta_dot);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::States *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::States *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_States__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, States)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_States__handle;
}
