...
#include <stddef.h>
#include "custom_msgs/msg/detail/states__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  custom_msgs__msg__States__init(message_memory);
}

void States__rosidl_typesupport_introspection_c__States_fini_function(void * message_memory)
{
  custom_msgs__msg__States__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember States__rosidl_typesupport_introspection_c__States_message_member_array[2] = {
  {
    "theta",  // name
    ...
    offsetof(custom_msgs__msg__States, theta),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs__msg__States, theta_dot),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers States__rosidl_typesupport_introspection_c__States_message_members = {
  ...
  "States",  // message name
  2,  // number of fields
  sizeof(custom_msgs__msg__States),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_msgs, msg, States)() {
