...
#include "custom_msgs/msg/detail/states__rosidl_typesupport_fastrtps_c.h"
...
using _States__ros_msg_type = custom_msgs__msg__States;
...
size_t get_serialized_size_custom_msgs__msg__States(
  const void * untyped_ros_message,
...
static uint32_t _States__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__States(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__States(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_custom_msgs__msg__States(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, States)() {
